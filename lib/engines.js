 ...
 * should use the `store()` function defined in consolidate.js
...
function cache(options, compiled) {
  ...
  if (compiled && options.filename && options.cache) {
    delete strCache[options.filename];
...
//  return waitFor(null, engine.render, path, options);
//};
...
//engines.just.render = function(str, options) {
//  var JUST = require('just');
